    ...
    <section class="page-section" id="tes">
        <div class="container">
            ...
            <form action="#" method="post">
                @csrf
                <div class="timeline-panel text-center mb-5 p-4 bg-light rounded">
                    <h4 class="subheading">
                        Anda memprioritaskan dan merencanakan tugas dengan efektif, seringkali menyelesaikannya jauh
                        sebelum tenggat waktu?
                    </h4>
                    <div class="form-group mt-4 d-flex justify-content-center align-items-center">
                        <label class="text-danger mr-3">Tidak Setuju</label>
                        <div class="form-check form-check-inline mx-4">
                            <input class="form-check-input" type="radio" name="answer1" id="tidak_setuju1"
                                value="tidak_setuju" required>
                            <label class="form-check-label" for="tidak_setuju1"></label>
                        </div>
                        <div class="form-check form-check-inline mx-4">
                            <input class="form-check-input" type="radio" name="answer1" id="setuju1"
                                value="setuju" required>
                            <label class="form-check-label" for="setuju1"></label>
                        </div>
                        <label class="text-success ml-3">Setuju</label>
                    </div>
                </div>

                <div class="timeline-panel text-center mb-5 p-4 bg-light rounded">
                    <h4 class="subheading">
                        Kisah dan penghayatan emosi seseorang mempunyai dampak lebih signifikan bagi Anda daripada angka
                        atau data.
                    </h4>
                    <div class="form-group mt-4 d-flex justify-content-center align-items-center">
                        <label class="text-danger mr-3">Tidak Setuju</label>
                        <div class="form-check form-check-inline mx-4">
                            <input class="form-check-input" type="radio" name="answer2" id="tidak_setuju2"
                                value="tidak_setuju" required>
                            <label class="form-check-label" for="tidak_setuju2"></label>
                        </div>
                        <div class="form-check form-check-inline mx-4">
                            <input class="form-check-input" type="radio" name="answer2" id="setuju2"
                                value="setuju" required>
                            <label class="form-check-label" for="setuju2"></label>
                        </div>
                        <label class="text-success ml-3">Setuju</label>
                    </div>
                </div>
                ...
                <div class="timeline-panel text-center mb-5 p-4 bg-light rounded">
                    ...
                    <div class="form-group mt-4 d-flex justify-content-center align-items-center">
                        <label class="text-danger mr-3">Tidak Setuju</label>
                        <div class="form-check form-check-inline mx-4">
                            <input class="form-check-input" type="radio" name="answer3" id="tidak_setuju3"
                                value="tidak_setuju" required>
                            <label class="form-check-label" for="tidak_setuju3"></label>
                        </div>
                        <div class="form-check form-check-inline mx-4">
                            <input class="form-check-input" type="radio" name="answer3" id="setuju3"
                                value="setuju" required>
                            <label class="form-check-label" for="setuju3"></label>
                        </div>
                        <label class="text-success ml-3">Setuju</label>
                    </div>
                </div>
